...
def save_model(args, epoch, model, model_without_ddp, optimizer, loss_scaler, output_dir, last = False):
    epoch_name = f'{epoch:05d}' if last == False else 'last'
...
def load_model_mcc(args, model_path, model_without_ddp, optimizer, loss_scaler):
