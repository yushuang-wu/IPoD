    ...
    def __getitem__(self, index):
        for retry in range(1000):
            try:
                ...
                full_point_cloud = co3d_utils._load_pointcloud(f'{self.args.co3d_path}/{category}/{sequence_name}/pointcloud.ply', max_points=self.max_points)
                full_point_cloud = pad_point_cloud(full_point_cloud, self.max_points)
                break
